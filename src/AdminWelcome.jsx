      ...
      <div className="w-full max-w-2xl z-10">
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 p-10 rounded-[40px] shadow-2xl">
          ...
          <div className="flex flex-col items-center mb-10">
            <div className="bg-blue-600 p-5 rounded-2xl shadow-lg shadow-blue-500/40 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
            <div className="bg-slate-800/50 border border-slate-700 p-5 rounded-2xl">
              <div className="bg-blue-600/20 p-2 rounded-xl w-fit mb-3">
                <Users className="text-blue-400 w-5 h-5" />
              </div>
              <h3 className="text-white font-bold text-sm uppercase mb-1">Student Management</h3>
            ...
            <div className="bg-slate-800/50 border border-slate-700 p-5 rounded-2xl">
              ...
              <h3 className="text-white font-bold text-sm uppercase mb-1">Course Management</h3>
            ...
            <div className="bg-slate-800/50 border border-slate-700 p-5 rounded-2xl">
              ...
              <h3 className="text-white font-bold text-sm uppercase mb-1">Enrollment</h3>
            ...
            <div className="bg-slate-800/50 border border-slate-700 p-5 rounded-2xl">
              ...
              <h3 className="text-white font-bold text-sm uppercase mb-1">Grade Entry</h3>
